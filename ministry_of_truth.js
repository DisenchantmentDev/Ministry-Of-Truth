function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 1171, function: Function { arguments: [Externref], shim_idx: 1172, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./ministry_of_truth_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ministry_of_truth_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
